...
export const _Cta = () => {
  return (
    ...
    >
      <div className="mx-auto grid w-full max-w-[1240px] overflow-hidden rounded-2xl border border-[#e5e7e1] bg-white shadow-[0_28px_72px_rgba(21,50,35,0.18)] lg:grid-cols-[58%_42%]">
        <div className="relative z-10 flex flex-col justify-center px-6 py-10 sm:px-10 sm:py-12 lg:px-14">
          ...
          <div className="mt-7">
            ...
            >
              ...
              <span className="text-2xl font-semibold tracking-[0.05em] sm:text-3xl">
                089-907-6504
              </span>
            </a>
