    ...
    sections: [
      {
        title: '全国で続く電気料金の値上げ',
        description:
          '2025年秋から冬にかけて、全国的に電気料金が値上げされています。燃料価格の高騰や政府の補助金終了の影響で、多くのご家庭で「昨年より電気代が高い」と感じる声が増えています。\n\n特に冬場は暖房などの使用量が増えるため、毎月の電気代が家計を圧迫しやすい季節です。',
      },
      {
        title: '電気を「買う」から「つくる・ためる」へ',
        description:
          'こうした背景から、太陽光発電と蓄電池を組み合わせた「自家消費型システム」への関心が急速に高まっています。\n\n昼間に太陽光で発電し、余った電気を蓄電池にためて夜間に使うことで、電力会社から買う電気を減らせます。結果として、電気代の削減だけでなく、停電時にも電気を使える安心感が得られます。',
      },
      {
        title: '導入事例と今後の展望',
        description:
          'アイビーホームでも、今年に入ってから太陽光・蓄電池に関するご相談が増えています。特に「電気代の見直し」や「災害対策」を目的にした導入が多く見られます。\n\n今後は、太陽光・蓄電池・エコキュートを組み合わせた「エネルギー効率の高い住まいづくり」を支援し、地域の皆さまの安心で快適な暮らしをサポートしてまいります。',
      },
    ],
  },
]
